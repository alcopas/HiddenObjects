    ...
    def get_new_game_data(self):
        hidden_objects = [
            [
                ...
                {"position": (1053, 867), "size": (101, 43), "name":"schildkroete", "id":6, "found":True},
                {"position": (590, 967), "size": (13, 18), "name":"eichhoernchen", "id":7, "found":True},
                {"position": (603, 959), "size": (23, 44), "name":"eichhoernchen", "id":7, "found":True},
            ...
            [
                ...
                {"position": (399, 1181), "size": (24, 17), "name":"kette", "id":4, "found":True},
                {"position": (23, 225), "size": (45, 48), "name":"hase", "id":5, "found":True},
                {"position": (323, 395), "size": (21, 25), "name":"cupcake", "id":6, "found":True},
                {"position": (522, 526), "size": (24, 17), "name":"socke", "id":7, "found":True},
            ...
            [
                ...
                {"position": (19, 286), "size": (68, 90), "name":"topf", "id":1, "found":True},
                {"position": (532, 338), "size": (37, 47), "name":"erdbeere", "id":2, "found":True},
                {"position": (1326, 476), "size": (69, 139), "name":"zwerg", "id":3, "found":True},
                {"position": (1541, 578), "size": (59, 26), "name":"karotte", "id":4, "found":True},
                {"position": (1224, 1087), "size": (21, 23), "name":"ei", "id":5, "found":True},
            ...
            [
                ...
                {"position": (1527, 201), "size": (32, 52), "name":"kristall", "id":1, "found":True},
                {"position": (933, 1123), "size": (46, 75), "name":"ballon", "id":2, "found":True},
                {"position": (86, 23), "size": (38, 32), "name":"uhr", "id":3, "found":True},
                {"position": (723, 510), "size": (24, 29), "name":"tulpe", "id":4, "found":True},
                {"position": (1449, 77), "size": (59, 27), "name":"schluessel", "id":5, "found":True},
                {"position": (649, 662), "size": (82, 43), "name":"gitarre", "id":6, "found":True},
                {"position": (1058, 643), "size": (19, 26), "name":"topf_wald", "id":7, "found":True}
            ],      
            [
                {"position": (224, 501), "size": (472, 52), "name":"ente", "id":0, "found":True},
                {"position": (9, 236), "size": (75, 78), "name":"hemd", "id":1, "found":True},
                {"position": (1450, 110), "size": (67, 33), "name":"cd", "id":2, "found":True},
                {"position": (1300, 547), "size": (51, 33), "name":"bonbon", "id":3, "found":True},
